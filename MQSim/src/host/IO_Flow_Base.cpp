...
#if (NEW_SUBMIT)
		read_log_file_user.close();
		write_log_file_user.close();
		command_log.close();
		//doodu_log.close();
#endif
...
#if (NEW_SUBMIT)
		read_log_file_user.open(logging_file_path + "_read_user.log", std::ofstream::out);
		write_log_file_user.open(logging_file_path + "_read_write.log", std::ofstream::out);
		command_log.open(logging_file_path + "_command_log.log", std::ofstream::out);
	//	doodu_log.open(logging_file_path + "_free_block.log", std::ofstream::out);
#endif
