...
#if NEW_SUBMIT
		attr = "Total_reads_while_erasing";
		val = std::to_string(Stats::Total_reads_while_erasing);
		xmlwriter.Write_attribute_string_inline(attr, val);

		attr = "Total_USER_reads_while_erasing";
		val = std::to_string(Stats::Total_USER_reads_while_erasing);
		xmlwriter.Write_attribute_string_inline(attr, val);

		attr = "Total_USER_reads_while_reading";
		val = std::to_string(Stats::Total_USER_reads_while_reading);
		xmlwriter.Write_attribute_string_inline(attr, val);

		attr = "Total_reads_while_writing";
		val = std::to_string(Stats::Total_reads_while_writing);
		xmlwriter.Write_attribute_string_inline(attr, val);

		attr = "Total_only_GC_read";
		val = std::to_string(Stats::Total_only_GC_read);
		xmlwriter.Write_attribute_string_inline(attr, val);

		attr = "Total_unserviced_R_barrier";
		val = std::to_string(Stats::Total_unserviced_R_barrier);
		xmlwriter.Write_attribute_string_inline(attr, val);

		attr = "Total_R_unserviced";
		val = std::to_string(Stats::Total_R_unserviced);
		xmlwriter.Write_attribute_string_inline(attr, val);

		attr = "Total_PRIMARY_ERS";
		val = std::to_string(Stats::Total_PRIMARY_ERS);
		xmlwriter.Write_attribute_string_inline(attr, val);

		attr = "Parallelism_GC_level";
		val = std::to_string(Stats::Parallelism_GC_level);
		xmlwriter.Write_attribute_string_inline(attr, val);

		attr = "serve_GC_read";
		val = std::to_string(Stats::serve_GC_read);
		xmlwriter.Write_attribute_string_inline(attr, val);

		attr = "serve_nothing_R";
		val = std::to_string(Stats::serve_nothing_R);
		xmlwriter.Write_attribute_string_inline(attr, val);

		attr = "IssuedSuspendProgramCMD_GC";
		val = std::to_string(Stats::IssuedSuspendProgramCMD_GC);
		xmlwriter.Write_attribute_string_inline(attr, val);

		attr = "cnt_check_gc";
		val = std::to_string(Stats::cnt_check_gc);
		xmlwriter.Write_attribute_string_inline(attr, val); 

		attr = "IssuedMultiplaneGCProgramCMD";
		val = std::to_string(Stats::IssuedMultiplaneGCProgramCMD);
		xmlwriter.Write_attribute_string_inline(attr, val);

		attr = "avg_GC_W_parallel";
		val = std::to_string(Stats::avg_GC_W_parallel);
		xmlwriter.Write_attribute_string_inline(attr, val);

		attr = "avg_USR_W_parallel";
		val = std::to_string(Stats::avg_USR_W_parallel);
		xmlwriter.Write_attribute_string_inline(attr, val);

		attr = "avg_GC_R_parallel";
		val = std::to_string(Stats::avg_GC_R_parallel);
		xmlwriter.Write_attribute_string_inline(attr, val);

		attr = "avg_USR_R_parallel";
		val = std::to_string(Stats::avg_USR_R_parallel);
		xmlwriter.Write_attribute_string_inline(attr, val);

		attr = "write_while_WRITING";
		val = std::to_string(Stats::write_while_WRITING);
		xmlwriter.Write_attribute_string_inline(attr, val);

		attr = "USRwrite_while_WRITING";
		val = std::to_string(Stats::USRwrite_while_WRITING);
		xmlwriter.Write_attribute_string_inline(attr, val);

		attr = "USRwrite_while_GCWRITING";
		val = std::to_string(Stats::USRwrite_while_GCWRITING);
		xmlwriter.Write_attribute_string_inline(attr, val);

		attr = "total_write_try";
		val = std::to_string(Stats::total_write_try);
		xmlwriter.Write_attribute_string_inline(attr, val);
