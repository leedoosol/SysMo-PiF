...
namespace SSD_Components
{
	...
	*/
	...
	public:
		...
		virtual struct cand_blks Check_gc_required(const unsigned int BlockPoolSize, const NVM::FlashMemory::Physical_Page_Address& planeAddress,int nextVictim) = 0;
		virtual int Check_gc_requiredForce(const unsigned int BlockPoolSize, const NVM::FlashMemory::Physical_Page_Address& planeAddress, int nextVictim, int isSubblock) = 0;
		virtual int Check_gc_required4align(const unsigned int BlockPoolSize, const NVM::FlashMemory::Physical_Page_Address& planeAddress, int nextVictim) = 0;
...
#if SOFT_ISOLATION
		void make_soft_isolation(const NVM::FlashMemory::Physical_Page_Address plane_address, flash_block_ID_type blockID);
#endif
