...
//#if NEW_SUBMIT
	unsigned int Stats::Total_reads_while_erasing = 0;
	unsigned int Stats::Total_USER_reads_while_erasing = 0;
	unsigned int Stats::Total_USER_reads_while_reading = 0;
	unsigned int Stats::Total_only_GC_read = 0;
	unsigned int Stats::Total_reads_while_writing = 0;
	unsigned int Stats::Total_unserviced_R_barrier = 0;
	unsigned int Stats::Total_R_unserviced = 0;
	unsigned int Stats::Total_PRIMARY_ERS = 0;
	double Stats::Parallelism_GC_level = 0;
	unsigned int Stats::serve_GC_read = 0;
	unsigned int Stats::serve_nothing_R = 0;
	unsigned int Stats::IssuedSuspendProgramCMD_GC = 0;
	unsigned int Stats::cnt_check_gc = 0;
	unsigned int Stats::IssuedMultiplaneGCProgramCMD = 0;
	double Stats::avg_USR_W_parallel = 0;
	double Stats::avg_GC_W_parallel = 0;
	double Stats::avg_GC_R_parallel = 0;
	double Stats::avg_USR_R_parallel = 0;
	unsigned int Stats::write_while_WRITING = 0; //write:include both GC and USER write.   WRITING: include both GC write and USER write.
	unsigned int Stats::USRwrite_while_WRITING = 0;
	unsigned int Stats::USRwrite_while_GCWRITING = 0;
	unsigned int Stats::total_write_try = 0;
	//#endif
