...
#if NEW_SUBMIT
		static unsigned int Total_reads_while_erasing;
		static unsigned int Total_USER_reads_while_erasing;
		static unsigned int Total_USER_reads_while_reading;
		static unsigned int Total_only_GC_read;
		static unsigned int Total_reads_while_writing;
		static unsigned int Total_unserviced_R_barrier;
		static unsigned int Total_R_unserviced;
		static unsigned int Total_PRIMARY_ERS;
		static double Parallelism_GC_level;
		static unsigned int serve_GC_read;
		static unsigned int serve_nothing_R;
		static unsigned int IssuedSuspendProgramCMD_GC;
		static unsigned int cnt_check_gc;
		static unsigned int IssuedMultiplaneGCProgramCMD;
		static double avg_USR_W_parallel;
		static double avg_GC_W_parallel;
		static double avg_GC_R_parallel;
		static double avg_USR_R_parallel;
		static unsigned int write_while_WRITING;
		static unsigned int USRwrite_while_WRITING;
		static unsigned int USRwrite_while_GCWRITING;
		static unsigned int total_write_try;
#endif
